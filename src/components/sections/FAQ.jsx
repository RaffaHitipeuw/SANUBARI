...
export default function FAQ() {
    return(
        <section className="relative grid grid-cols-12 max-sm:grid-cols-1 px-40 max-sm:px-4 gap-6 max-sm:gap-8 py-20">
            ...
            <Badges type={'maa'} className={'absolute size-150 -z-1 opacity-5 top-10 -right-60'}/>
        </section>
    )
}