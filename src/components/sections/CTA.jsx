...
export default function CTA() {
    return(
        <section className="h-screen max-sm:h-[120vh] flex items-center justify-center relative px-40">
            ...
            <button className="relative top-[-6%] max-sm:top-[8%] right-[-10%] z-4 bg-white px-18 max-sm:px-12 py-4 max-sm: text-2xl max-sm:text-base whitespace-nowrap rounded-3xl max-sm:rounded-2xl border border-sariblack cursor-pointer hover:scale-105 transition-all duration-112">Daftar Sekarang!</button>
            <span className="w-full h-full absolute flex justify-center items-center">
