      ...
      <div className="pr-0 max-sm:pr-4 p-4 h-full max-sm:h-max max-sm:w-full max-sm:absolute max-sm:bottom-0 max-sm:z-999">
        ...
        >
          ...
          <nav className="bg-white overflow-clip border border-sariblack/14 h-full max-sm:h-max max-sm:w-full rounded-2xl flex flex-col max-sm:flex-row items-stretch justify-between">
            ...
            <ul
              className='flex flex-col max-sm:flex-row h-full gap-2 max-sm:gap-1 p-4 max-sm:p-2 relative max-sm:justify-between max-sm:w-full max-sm:overflow-auto'
            ...
            >
              ...
              {navItems.map((item, index) => (
                ...
                <li key={index}>
                  ...
                  <NavLink
                    to={item.path}
                    className='border border-transparent hover:border-sarired hover:bg-sarired/14 rounded-2xl max-sm:rounded-xl hover:text-sarired transition duration-75 flex items-center max-sm:justify-center px-4 max-sm:p-0 h-14 text-base max-sm:aspect-square max-sm:size-14'
                  >
